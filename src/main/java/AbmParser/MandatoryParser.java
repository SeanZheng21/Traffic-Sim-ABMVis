...
/**
 * The abstract mandatory parser concept that processes a file that contains sim info to one type instances of AbmModel
...
public abstract class MandatoryParser extends Parser {
    ...
    /**
     * Creates a mandatory parser, called by the parser configurer
     ...
     */
    public MandatoryParser(String inputFile, String modelName, String path, String superModeName, Set<String> types) {
     ...
     */
    @Override
    public abstract Set<MandatorySimModel> parse() throws ParserException;
