...
/**
 * This represent the action: The vehicle enter in the link
 */
public class RunnableVehicleEntersLink extends RunnableTrafficEvent {
     ...
     */
    public RunnableVehicleEntersLink(VehicleEntersLink event, UIVehicle vehicle, UILink link) {
