...
/**
 * Abstract PersonEntersVehicle event concept that represents an acceptable PersonEntersVehicle event for Abm
 * This type of event represent a person entering into a vehicle
 * Mandatory concept
 */
public abstract class PersonEntersVehicle extends BoardingEvent implements MandatorySimModel {
     ...
     */
    public PersonEntersVehicle(int id, double time, String type, double x, double y, int person, int vehicle, int link, int facility, Map<String, Set<String>> types, Vehicle vehicleObject, Person personObject) {
