...
/**
 * Abstract VehicleEntersLink event concept that represents an acceptable VehicleEntersLink event for Abm
 * This type of event represent a vehicle entering into a link
 * Mandatory concept
 */
public abstract class VehicleEntersLink extends TrafficEvent implements MandatorySimModel {
     ...
     */
    public VehicleEntersLink(int id, double time, String type, double x, double y, int person, int vehicle, int link, int facility, Map<String, Set<String>> types, Vehicle vehicleObject, Link linkObject) {
