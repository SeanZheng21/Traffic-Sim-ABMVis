...
/**
 * Implementation TrafficEvent concept that represents an acceptable TrafficEvent for Abm
 * A TrafficEvent is related to the circulation along the link
 * Mandatory concept implementation
 */
@Deprecated
public class MSTrafficEvent extends TrafficEvent {
     ...
     */
    public MSTrafficEvent(int id, double time, String type, double x, double y, int person, int vehicle, int link, int facility, Map<String, Set<String>> types, Vehicle vehicleObject, Link linkObject) {
     ...
     */
    public MSTrafficEvent(MSTrafficEvent msTrafficEvent) {
     ...
     */
    public MSTrafficEvent(MSLegEvent msLegEvent) {
     ...
     * @param msEvent Event
     */
    public MSTrafficEvent(MSEvent msEvent) {
