...
/**
 * Implementation ActStart event concept that represents an acceptable ActStart event for Abm
 * This type of event represent the start of an activity
 * Mandatory concept implementation
 */
public class MSActStart extends ActStart {
     ...
     */
    public MSActStart(int id, double time, String type, double x, double y, int person, int vehicle, int link, int facility, Map<String, Set<String>> types, Person personObject, Facility facilityObject) {
    ...
    /**
     * copy constructor from MSActStart
     * @param msActStart Event
     */
    public MSActStart(MSActStart msActStart) {
        super(msActStart.getId(), msActStart.getTime(), msActStart.getType(), msActStart.getX(), msActStart.getY(), msActStart.getPerson(), msActStart.getVehicle(), msActStart.getLink(), msActStart.getFacility(), msActStart.getTypes(), msActStart.getPersonObject(), msActStart.getFacilityObject());
    }
     ...
     */
    public MSActStart(MSActEvent msActEvent) {
     ...
     * @param msEvent Event
     */
    public MSActStart(MSEvent msEvent) {
